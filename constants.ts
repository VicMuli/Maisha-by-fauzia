...
export const SERVICES: Service[] = [
  {
    ...
    faqs: [
      ...
      { question: 'What is PMOS and how is it treated?', answer: 'Polycystic Menstrual Ovarian Syndrome (PMOS) is a hormonal disorder causing irregular periods, excess androgens, and polycystic ovaries. Treatment may include lifestyle changes, hormonal medications, or fertility treatments depending on your goals.' },
  ...
  },
  {
    ...
    description: 'A nurturing and comprehensive care journey, from preconception counseling and pregnancy monitoring to delivery and dedicated postpartum support for mothers.',
    icon: 'Baby',
    details: `Pregnancy is one of the most transformative journeys of a woman's life, and at Maisha Medical, we walk every step alongside you. Our Antenatal care begins even before conception with preconception counseling to optimize your health for pregnancy. Throughout your pregnancy, we provide comprehensive monitoring including ultrasound scans, nutritional guidance, prenatal screening, Lamaze exercises, and management of high-risk conditions such as gestational diabetes and preeclampsia. Dr. Fauzia believes in empowering mothers with knowledge and reassurance at every trimester. Postnatal care is equally prioritized — from post-delivery check-ups and breastfeeding support to screening for postpartum depression, Lamaze exercises for recovery, and complete recovery guidance. Exercises encouraged during and after pregnancy include walking, yoga, and Lamaze breathing techniques. Our goal is a safe, informed, and deeply supported pregnancy and motherhood experience from start to finish.`,
    faqs: [
      ...
      { question: 'What does postnatal care include?', answer: 'Postnatal care includes postpartum physical examinations, wound care if applicable, mental health screening for postpartum depression, breastfeeding support, contraceptive counseling, and Lamaze exercises for postnatal recovery.' },
      ...
      { question: 'Can I continue exercising during pregnancy?', answer: 'In most cases, moderate exercise is safe and beneficial during pregnancy. Exercises encouraged include walking, yoga, and Lamaze exercises. However, the type and intensity should be discussed with Dr. Fauzia, especially if any risk factors are present. She will provide personalized guidance.' },
    ]
  },
  {
    id: 'cosmetic',
  ...
  },
  {
    ...
    faqs: [
      { question: 'Which contraceptive method is most suitable for me?', answer: 'The contraceptive methods to be used depend on your patient profile. Dr. Fauzia will advise you on the methods that are suitable and those that are not suitable for you, based on your individual health history, lifestyle, and reproductive goals.' },
  ...
  },
  {
    ...
    description: 'Proactive and vigilant early detection services. We offer Pap smears, HPV testing, and comprehensive breast health examinations to safeguard your health.',
    icon: 'Activity',
    details: `Early detection saves lives, and Maisha Medical is committed to providing thorough, proactive cancer screening services for women. Our Cancer Screening programme encompasses Pap smear tests and HPV testing for cervical cancer detection, clinical breast examinations, and referrals for mammography where appropriate. Dr. Fauzia understands the anxiety that can accompany screening and ensures every appointment is conducted with sensitivity and clarity. She provides detailed explanations of results, next steps, and what findings mean in practical, reassuring terms. Regular screening is recommended regardless of whether you have symptoms, as many gynaecological cancers are asymptomatic in early stages. Dr. Fauzia advises patients not to wait for symptoms and encourages frequent screening for early detection. Our clinic follows internationally recognised guidelines to ensure your screening schedule is appropriate for your age, risk factors, and health history. Protecting your long-term health through preventive vigilance is the cornerstone of our cancer screening service.`,
    faqs: [
      { question: 'At what age should I start cervical cancer screening?', answer: 'Cervical cancer screening typically begins at age 21. Women aged 21–29 should have a Pap smear every 3 years. From age 30–65, co-testing with a Pap smear and HPV test is recommended every 5 years. Additionally, the HPV vaccine is recommended for young boys and girls as a preventive measure against HPV-related cancers. Dr. Fauzia will advise based on your history.' },
      ...
      { question: 'When should I go for cancer screening?', answer: 'Dr. Fauzia advises patients not to wait for symptoms before seeking cancer screening. Frequent and regular screening is strongly encouraged, as many gynaecological cancers have no symptoms in their early stages. Early detection significantly improves treatment outcomes. Do not wait — schedule your screening today.' },
    ]
  },
  {
    id: 'reproductive',
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What conditions can an ultrasound detect?', answer: 'Ultrasound can detect uterine fibroids, ovarian cysts, ectopic pregnancy, signs of PMOS, fetal development concerns, and more. It is a versatile and invaluable diagnostic tool in gynaecological practice.' },
